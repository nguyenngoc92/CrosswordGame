...
public class KeyboardView extends LinearLayout implements OnTouchListener {
	...
	public void initComponent() {
		...
		ViewGroup keyboard = (ViewGroup) inflater.inflate(R.layout.keyboard,
				null);
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN: {
			...
			// Change key background (selector actually doesn't work with
			// KeyboardView)
			if (v.getId() == R.id.buttonDELETE)
				this.currentView
						.setBackgroundResource(R.drawable.btn_keyboard_delete_pressed);
			else if (v.getId() == R.id.buttonDRAFT)
				this.currentView
						.setBackgroundResource(this.isDraft ? R.drawable.btn_keyboard_draft_pressed_lock
								: R.drawable.btn_keyboard_draft_pressed_lock);
			else
				this.currentView
						.setBackgroundResource(R.drawable.btn_keyboard_pressed);

			if (this.value != null)
				this.delegate.onKeyDown(value, location,
		...
		case MotionEvent.ACTION_UP: {
			...
			if (v.getId() == R.id.buttonDELETE)
				this.currentView
						.setBackgroundResource(R.drawable.btn_keyboard_delete_release);
			else if (v.getId() == R.id.buttonDRAFT)
				this.currentView
						.setBackgroundResource(this.isDraft ? R.drawable.btn_keyboard_draft_release_lock
								: R.drawable.btn_keyboard_draft_release_unlock);
			else
				this.currentView
						.setBackgroundResource(R.drawable.btn_keyboard_release);
